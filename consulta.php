...
<div class="col-md-7 col-lg-8" style="position:absolute;left:50%;transform:translateX(-50%);">
        <h4 class="mb-3" style="display:flex;align-items:center;justify-content:center;">Consulta de Manutenção</h4>
        <form class="needs-validation" novalidate action="consultando.php" method="post" style="display:flex;align-items:center;justify-content:center;">
          <div class="row g-3">
            <div class="col-sm-6">
              <label for="firstName" style="display:flex;align-items:center;justify-content:center;position:relative;left:50%;" class="form-label">Código da Consulta</label>
              <input type="text" required style="position:relative;left:15%;width:175%;" class="form-control" id="cod" name="cod" value="">
              <div class="invalid-feedback" style="margin-left:130px;">
                Requer um código
              </div>
            </div>
          ...
          <button class="w-100 btn btn-primary btn-lg" type="submit">Consultar</button>
        </form>
      </div>
    </div>
  </main>
